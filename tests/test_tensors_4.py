...
def test_shape_and_dtype(graph_tensor) -> None:
    ...
    assert graph_tensor.edge_dst.dtype.name == 'int64'
    assert graph_tensor.edge_src.dtype.name == 'int64'

    graph_tensor = graph_tensor.merge()

    assert graph_tensor.graph_indicator.dtype.name == 'int64'
...
def test_merge_and_separate(graph_tensor) -> None:
    ...
    assert graph_tensor_merged.edge_dst.dtype.name == 'int64'
    assert graph_tensor_merged.edge_src.dtype.name == 'int64'
    assert graph_tensor_merged.graph_indicator.dtype.name == 'int64'
